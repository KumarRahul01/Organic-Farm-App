...
const Contact = () => {
  ...
  return (
    <>
      <div className="sm:w-10/12 px-3 sm:mb-10 sm:px-0 mx-auto">
        <h1
          data-aos="fade-right"
        ...
        <p className="text-gray-700 text-center mt-7 mb-10 text-lg">
          Reach out for a massive discounts on bulk orders
        </p>
        ...
        <div className="lg:flex gap-6">
          ...
          <div
            data-aos="fade-up"
            className="lg:w-[40%] px-10 py-5 shadow-xl border-t-[3px] border-b-[3px] border-green-500 mb-7 lg:mb-0"
          >
            <div className="flex gap-3 mt-3 mb-12">
              <div
                className="rounded-full h-fit border-zinc-200 border p-2"
          ...
          <div
            ...
            className="lg:w-[60%] px-10 py-5 shadow-xl border-t-[3px] border-b-[3px] border-green-500"
          >
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="md:w-[50%]">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-10 px-3 my-3 rounded border border-zinc-300 focus:border focus:border-green-500 outline-none"
                    />
                  </div>
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-60 p-3 my-3 rounded border border-zinc-300 focus:border focus:border-green-500 outline-none resize-none"
                ></textarea>
              </div>

              <div className="flex justify-center m-3">
                <button className="px-4 py-2 bg-green-500 text-white font-medium rounded-md">
                  Send Message
                </button>
              </div>
            </form>
